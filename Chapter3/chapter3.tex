...
The beams, consisting of approximately 1400 bunches of $\orderof(10^{11})$ protons,
...
\emph{show plots of the instantaneous lumi and integ lumi throughout run I}

\begin{figure}[h!]
  \centering
  \begin{subfigure}[b]{0.46\textwidth}
    \includegraphics[width=\textwidth]{Figs/machine/int_lumi_per_week_pp_2012.pdf}
    \label{fig:int_lumi_week}
  \end{subfigure}
  \begin{subfigure}[b]{0.46\textwidth}
    \includegraphics[width=\textwidth]{Figs/machine/int_lumi_per_week_cumulative_pp_2012.pdf}
    \label{fig:int_lumi_week_cumu}
  \end{subfigure}
  \caption{The integrated luminosity delivered to and recorded at the CMS 
  detector throughout 2012, split by week.}
  \label{fig:int_lumi_2012}
\end{figure}
...
where blah blah. Differences in these two variables, namely $\Delta \phi$ and $\Delta 
...
into super-towers (\emph{how many per supertower??}, to match with towers
...
avalanche photo-diodes are used in the barrel and vacuum photo-triodes in the
...
muon systems as well as other interior subdetector systems.}
\end{figure}
...
Events of interest are selected using a dedicated triggering system,
