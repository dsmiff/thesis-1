...
the kinematics of the stop system should have no dependence whatsover on the 
decay channel, any discrepancy must be artifical [BETTER WORD?], and should 
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.6\textwidth, page=16]{Figs/sms/t2degen/corrs/output_T2ccVsT2_4body_300_dM10_inc_inc_noCuts.pdf}
  \caption{Comparison of the vectorially summer generator-level \Pt of the
  pair-produced \sTop particles, between the \texttt{T2cc} (red) and
  \texttt{T2Degen} (blue) 
  samples, for the mass point (300, 290) \gev. No selection cuts are made.}
