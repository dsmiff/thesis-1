...
Example cut-flows from the signal region are shown in Table~\ref{tab:t2cc_cutflow}
for two mass points
...
Example cut-flows from the signal region are shown in
Table~\ref{tab:t2_4body_cutflow} for two mass points with extremal \deltam,
at an $m_{\sTop}$ value near the limit of sensitivity.
...
\begin{figure}[b!]
    ...
    with the vectorial sum of lepton \Pt's (left) and of the recoil jets (right)~\cite{susy-isrrw}.}
...
both the charm and four-body decay signal samples at the event level, where the 
...
\begin{table}[ht!]
  ...
  \begin{tabular}{ lc }
    \hline
    \hline
    boost $\Pt$ (\gev)    & Correction Factor \\
    \hline
    $0 <\Pt\leq120    $          & 1.00 \\
    $120 <\Pt\leq150  $          & 0.95 \\
    $150 <\Pt\leq250  $          & 0.90 \\
...
Although signal systematics are considered in the likelihood model as a function
of the \HT dimension of the 
...
have further \FASTSIM to \FULLSIM correction factors applied, as recommended
by~\cite{btagpogtwiki}.
...
of the luminosity measurement, as quoted by the Lumi \emph{POG} at
2.5\%~\cite{CMS:2013gfa}.
...
\begin{table}[h!]
  ...
  \begin{tabular}{ lcccccccccc }
    ...
    PDF        &           &                  &          &                       &         &                       &         &             & 0.04    & 0.14  \\
    JES        &       &              &      &                  &     &                   &     &                                       & 0.02 & 0.10 \\
    ISR        & 0.11      & 0.21             & 0.08     & 0.21                 & 0.16    & 0.22                  & 0.14    & 0.23        && \\
    b tag SF   & 0.01      & 0.02             & 0.03     & 0.07                 & 0.01    & 0.02                  & 0.02    & 0.06        && \\
    \mht/\met  & 0.02      & 0.02             & 0.02     & 0.02                  & 0.02    & 0.02                  & 0.02    & 0.02        && \\
    Dead ECAL  & 0.02      & 0.02             & 0.02     & 0.02                  & 0.02    & 0.02                  & 0.02    & 0.02        && \\
    \hline
    Total syst & 0.15      & 0.21             & 0.09     & 0.22                 & 0.16    & 0.22                  & 0.15    & 0.24        && \\
    \hline
    \hline
  \end{tabular}
\end{table}
...
\begin{table}[h!]
  ...
  \begin{tabular}{ lcccccccccc }
    ...
    PDF        &           &                  &          &                       &         &                       &         &                        & 0.04      & 0.14\\
    JES        &      &             &     &                 &    &                  &    &                   & 0.01 & 0.07\\
    ISR        & 0.15      & 0.20             & 0.14     & 0.21                 & 0.17    & 0.21                  & 0.16    & 0.23                   &      &\\
    b tag SF   & 0.01      & 0.02             & 0.02     & 0.07                 & 0.01    & 0.03                  & 0.00    & 0.06                   &      &\\
    \mht/\met  & 0.02      & 0.02             & 0.02     & 0.02                  & 0.02    & 0.02                  & 0.02    &  0.02                  &           &\\
    Dead ECAL  & 0.02      & 0.02             & 0.02     & 0.02                  & 0.02    & 0.02                  & 0.02    &  0.02                  &           &\\
    \hline                                                                                                                                                        
    Total syst & 0.15      & 0.20             & 0.15     & 0.22                 & 0.17    & 0.22                  & 0.16    & 0.24                   &      &\\
    \hline
    \hline
  \end{tabular}
\end{table}
...
while maintaining sensitivity across the \deltam range relevant to both models -
