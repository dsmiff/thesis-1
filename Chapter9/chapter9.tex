...
Example cut-flows are shown in table~\ref{tab:t2cc_cutflow} for mass points with
...
Example cut-flows are shown in table~\ref{tab:t2_4body_cutflow} for a mass point
