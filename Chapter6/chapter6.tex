...
shown here, is performed for the \mmj control region.
...
Also shown in Table~\ref{tab:syst-fits-ge4j}, significantly improved
fit parameters are observed when the same fit is made while ignoring this bin.
...
the large ensemble considered showing a sign of a poor fit, further
...
the the single-object \HT trigger, \verb!HLT_HT750!, which remained un-prescaled
