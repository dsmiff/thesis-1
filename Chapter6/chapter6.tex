...
For EWK backgrounds (genuine MET) we use control samples - what are they? - how 
do we use them?
...
\caption{Summary of the predicted QCD multijet background contribution
  ...
  the uncertainty comprises both stat. and syst. components. RE}
...
\begin{figure}[ht!]
  ...
  \caption{Sets of closure tests (open symbols) overlaid on top of
      ...
      order polynomial fits to each set of closure tests. RE}
...
\begin{table}[!ht]
  \caption{A summary of the results obtained from fits of zeroeth
    ...
    the $p$-value for the linear fit. RE}
