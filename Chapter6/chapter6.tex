...
prediction process.
Subsequently, the QCD expectations as shown in the plots gain a non-zero error
but crucially remain statistically compatible with zero. This mirrors the
conclusion found
in simulation that the heavy flavour QCD events are removed by the application
of the \mindphistar > 0.3 requirement.
