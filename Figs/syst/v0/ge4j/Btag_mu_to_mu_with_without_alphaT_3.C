...
//=========  (Wed Apr  2 22:56:40 2014) by ROOT version5.34/09
   ...
   grae->SetPoint(1,237.5,0.06552928);
   grae->SetPointError(1,0,0,0.06116263,0.06116263);
   grae->SetPoint(2,300,0.0703838);
   grae->SetPointError(2,0,0,0.03677246,0.03677246);
   grae->SetPoint(3,350,-0.1276105);
   grae->SetPointError(3,0,0,0.05321735,0.05321735);
   grae->SetPoint(4,425,-0.1096958);
   grae->SetPointError(4,0,0,0.05470022,0.05470022);
   grae->SetPoint(5,525,-0.09454605);
   grae->SetPointError(5,0,0,0.06897695,0.06897695);
   grae->SetPoint(6,625,-0.01981856);
   grae->SetPointError(6,0,0,0.1010678,0.1010678);
   grae->SetPoint(7,725,0.1240722);
   grae->SetPointError(7,0,0,0.159254,0.159254);
   grae->SetPoint(8,825,-0.02585268);
   grae->SetPointError(8,0,0,0.2623365,0.2623365);
   grae->SetPoint(9,925,0.007559698);
   grae->SetPointError(9,0,0,0.4002596,0.4002596);
   grae->SetPoint(10,1025,-0.102281);
   grae->SetPointError(10,0,0,0.5780835,0.5780835);
   grae->SetPoint(11,1125,-0.5484551);
   grae->SetPointError(11,0,0,0.570925,0.570925);
   ...
   fit->SetParameter(0,-0.01517506);
   fit->SetParError(0,0.02198735);
   ...
   TText *text = ptstats->AddText("#chi^{2} / ndf =  17.6 / 10");
   text = ptstats->AddText("p0       = -0.01518 #pm 0.02199 ");
