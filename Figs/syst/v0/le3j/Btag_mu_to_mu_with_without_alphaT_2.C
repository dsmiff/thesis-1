...
//=========  (Wed Apr  2 22:55:11 2014) by ROOT version5.34/09
   ...
   grae->SetPoint(1,237.5,0.001497126);
   grae->SetPointError(1,0,0,0.01774844,0.01774844);
   grae->SetPoint(2,300,-0.007236118);
   grae->SetPointError(2,0,0,0.02245838,0.02245838);
   grae->SetPoint(3,350,-0.03645276);
   grae->SetPointError(3,0,0,0.0287866,0.0287866);
   grae->SetPoint(4,425,-0.06264763);
   grae->SetPointError(4,0,0,0.03185507,0.03185507);
   grae->SetPoint(5,525,-0.08585182);
   grae->SetPointError(5,0,0,0.05332692,0.05332692);
   grae->SetPoint(6,625,-0.1608641);
   grae->SetPointError(6,0,0,0.0899826,0.0899826);
   grae->SetPoint(7,725,0.1828398);
   grae->SetPointError(7,0,0,0.1596722,0.1596722);
   grae->SetPoint(8,825,-0.2275839);
   grae->SetPointError(8,0,0,0.2475073,0.2475073);
   grae->SetPoint(9,925,-0.1974556);
   grae->SetPointError(9,0,0,0.391579,0.391579);
   grae->SetPoint(10,1025,-0.3199019);
   grae->SetPointError(10,0,0,0.6402325,0.6402325);
   grae->SetPoint(11,1125,-0.6311157);
   grae->SetPointError(11,0,0,0.7456548,0.7456548);
   ...
   fit->SetParameter(0,-0.02092608);
   fit->SetParError(0,0.0112574);
   ...
   TText *text = ptstats->AddText("#chi^{2} / ndf = 11.29 / 10");
   text = ptstats->AddText("p0       = -0.02093 #pm 0.01126 ");
