...
\mcttw. Transfer factors are defined as the inverse as those of the analysis:
% 
\begin{equation}
...
pseudo-experiments. Figure~\ref{fig:pull_analysis} summarises various
distributions of these two values.
...
significant with 0 and 1, respectively. Furthermore, the distribution of
