...
that region, as the fit is not `pulled' by observations from the signal region.
Differences between the prediction and the data observations are found in the
\mmj and \gj control regions, due to the fit considering both control regions
...
observations in the signal region can affect the
fit in the control regions. This is most noticeable in the \mmj and \gj samples,
but only marginally in the \mj sample where the relatively large systematics of
