...
The `a-priori' fit results described in Section~\ref{sec:results_fit_green} shows the comparison
...
in general good agree is obs, with only some bins deviating by up to 2.8 sigma.
