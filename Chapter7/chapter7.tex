...
are shown in figures~\ref{fig:green_fits_ge4j} and summarised in tabular form in
tables~REF.

\subsection{Fit with Signal region}
An ``a posteriori'' fit is made by considering every region, including the
hadronic signal region's observation in data, and is shown in figures~REF and
summarised in tables~REF.
...
%     {Figs/results/v0/greenBand/bestFit_2012dev_RQcdZero_fZinvAll_0b_ge4j-12p_smOnly.pdf}
%     \caption{\njhigh, $\nb = 0$.}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.46\textwidth}
...
%   \begin{subfigure}[b]{0.46\textwidth}
%     \includegraphics[width=\textwidth, page=1]
%     {Figs/results/v0/greenBand/bestFit_2012dev_RQcdZero_fZinvAll_1b_ge4j-12p_smOnly.pdf}
%     \caption{\njhigh, $\nb = 1$.}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.46\textwidth}
%     \includegraphics[width=\textwidth, page=2]
...
%   \begin{subfigure}[b]{0.46\textwidth}
%     \includegraphics[width=\textwidth, page=1]
%     {Figs/results/v0/greenBand/bestFit_2012dev_RQcdZero_fZinvAll_2b_ge4j-1_smOnly.pdf}
%     \caption{\njhigh, $\nb = 2$.}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.46\textwidth}
%     \includegraphics[width=\textwidth, page=2]
...
%   \begin{subfigure}[b]{0.46\textwidth}
%     \includegraphics[width=\textwidth, page=1]
%     {Figs/results/v0/greenBand/bestFit_2012dev_RQcdZero_fZinvAll_3b_ge4j-1_smOnly.pdf}
%     \caption{\njhigh, $\nb = 3$.}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.46\textwidth}
%     \includegraphics[width=\textwidth, page=2]
...
%   \begin{subfigure}[b]{0.46\textwidth}
%     \includegraphics[width=\textwidth, page=1]
%     {Figs/results/v0/greenBand/bestFit_2012dev_RQcdZero_fZinvAll_ge4b_ge4j-1_smOnly.pdf}
%     \caption{\njhigh, $\nb \geq 4$.}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.46\textwidth}
%     \includegraphics[width=\textwidth, page=2]
