...
\begin{figure}[hb!]
\centering
\hspace{1.8cm}\includegraphics[width=0.7\textwidth, trim=0 30 0 30, clip=true]
{Figs/ra1_had_bg_comp_v2.pdf}
...
figure~\ref{fig:datamc_had_inc}, comparing data against MC. CHANGE TO MC ONLY
