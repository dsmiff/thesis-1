...
by the black contours of constant \alphat. 
% QCD mainly populates a region of low \mht, 
% sitting below the contours of \alphat,
% (Figure~\ref{fig:alphat_corr_qcd}), while processes with real \met sit also at
% higher values of \mht and \alphat, as can be seen with both the SM and SUSY
% processes (Figures~\ref{fig:alphat_corr_zinv} and \ref{fig:alphat_corr_t2cc}).
