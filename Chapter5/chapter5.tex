...
\begin{figure}[!ht]
  \centering
    ...
    \begin{subfigure}[b]{0.48\textwidth}
      \includegraphics[width=\textwidth,page=11]{Figs/datamc/Stacked_AlphaT_all_200_upwards}
      \caption{\alphat}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\textwidth}
      \includegraphics[width=\textwidth,page=18]{Figs/datamc/Stacked_HT_all_200_upwards}
      \caption{\HT}
    \end{subfigure} \\
    \begin{subfigure}[b]{0.48\textwidth}
      \includegraphics[width=\textwidth,page=11]{Figs/datamc/Stacked_MHT_all_200_upwards}
      \caption{\mht}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\textwidth}
      \includegraphics[width=\textwidth,page=18]{Figs/datamc/Stacked_CommonJetPt_all_200_upwards}
