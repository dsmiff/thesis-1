...
\end{equation}
% 
This variable is plotted as a function of \alphat after subtracting the
predicted EWK background (as determined using the method outlined in
...
\mhtmet < 1.25 region, a constant pedestal in \alphat is observed REF REF,
leading to the conclusion of residual QCD contamination in the signal region.
