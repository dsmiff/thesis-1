...
Events containing sources of genuine \met, whether from SM or BSM sources, have values
of $\alphat > 0.5$.
...
decayed using \PYTHIA \emph{(too vague?)}. Up to two additional partons are simulated 
...
% \subsubsection{ISR reweighting of MC signal samples}
