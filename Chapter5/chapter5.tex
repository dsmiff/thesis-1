...
\begin{figure}[hb!]
\centering
\hspace{1.8cm}\includegraphics[width=0.7\textwidth]{Figs/ra1_had_bg_comp_v2.pdf}
...
Exclusively for this analysis, the additional `Parked' trigger with \HT > 200
\gev and \alphat > 0.57 thresholds is included, seeding the new \HT> 200 \gev
bin. Such a low
...
The advantage of this variable with respect to the widely used
$\Delta R(jet, MHT)$ is it's detection of missing energy vectors caused by both
under-measurements and over-measurements of a jet's transverse momentum.
...
Determining yields for high values of \nb directly from simulation becomes
