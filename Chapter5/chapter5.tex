...
configuration conspires to give a topology that gives high values of \alphat.
...
between the event \mht, calculated excluding jet $j$, and the jet itself is defined
as:
% 
\begin{equation}
...
un-discovered and therefore rare detector effects may still be
