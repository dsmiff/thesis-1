...
hadronizing and showering throughout the calorimeter systems. Energy deposits 
...
Particle Flow techniques to reconstruct `PFJets', this analysis continues to use `caloJets'
...
sums. The definitions of the energy sum variables are:
% 
\begin{equation}
    \begin{split}
    \Et = \sum_{i}^{} |\Ptvect_i| , \\
...
hadronic energy and total transverse missing hadronic energy. These are calculated on
the fly in the analysis using identified objects,
with the exception of \met which is constructed from PF objects and subject to type-I
