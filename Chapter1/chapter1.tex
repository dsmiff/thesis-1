...
blocks of the universe has been searched for. For Particle Physicits, this is
the ultimate goal - a complete understanding of the nature of the Universe on a
fundamental level. If we can describe to smallest possible constituents of the
matter and how these constituents interact, then we can ultimately understand
...
Depsite it's continued accuracy in the face of substantial scrutiny, the
Standard Model fails to explain large facts of the Universe (better than that),
and as such is widely considered as a low energy regime of some greater theory. 
